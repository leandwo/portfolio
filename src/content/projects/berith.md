...
features:
  ...
  - title: Seating chart
    description: Drag-and-drop table assignment. Seat guests, move them around, and handle last-minute changes without losing your mind.
  - title: Budget tracker
    description: Add line items, set estimates, mark what's been paid. See where you stand at a glance.
  - title: Vendor directory
    description: All your vendor contacts, contracts, and deadlines in one place. No more digging through email threads.
