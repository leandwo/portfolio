...
features:
  - title: Asset catalog
    description: Add any piece of gear, including instruments, cables, mics, projectors, and furniture. Anything the church owns.
  ...
  - title: Condition tracking
    description: Mark items as good, needs attention, or out of service. Know what needs to be fixed or replaced before Sunday.
  - title: Quick search
    description: Find any item instantly. Search by name, category, or notes.
  - title: Dashboard
    description: A summary view of your full inventory, with counts by category and items flagged for attention.
  - title: Cloud storage
